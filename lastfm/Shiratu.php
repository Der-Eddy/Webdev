...
$tmp = $_SERVER[DOCUMENT_ROOT]. "/webdev/recenttracks_shiratu.txt";
...
$artist = $info_track[0];
$title = $info_track[1];
if (strlen($title) > 44){$title = substr($title, 0, 42) . "...";}
...
ImageTTFText ($im, 14, 0, 0, 20, ImageColorAllocate($im, 0, 0, 0), "arialuni.ttf", "Last heard on Windows Media Player:");
for ($i = 0; $i <= $tracks; $i++){
